...
@section('content')
    <title>KGF | Board of Directors List</title>
        ...
        <section class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-success alert-dismissible">
                            ...
                            <h5><i class="icon fas fa-check"></i> Board of Directors</h5>
                            {{ $message }}
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-striped projects table-hover" id="employee_table">
                        <thead>
                            <tr>
                                <th>Picture</th>
                                <th>Member Name</th>
    ...
    <div class="modal fade" id="employee_modal">
            ...
            <form action="{{ route('admin-settings-employee') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Create Board of Directors</h4>
        ...
        <div class="modal fade" id="employee_update_modal">
            <div class="modal-dialog modal-lg">
                <form action="{{ route('admin-settings-employee-update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Update Board Director</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
        ...
        <div class="modal fade" id="delete_modal">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Delete Board Director</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <span>You're About To Delete <b><span id="employeeName"></span></b> Board Director</span>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
