        ...
        <div class="card">
            <div class="card-header header-elements">
                ...
                <div class="card-header-elements ms-auto">
                    ...
                    <h6 class="m-0 me-2">Income Head</h6>
                            ...
                            @foreach ($income_list as $item)
                                <tr>
                                    <td>
                                        <div class="row">
                                            <div class="col-2">
                                                <img src="{{ asset($item->logo) }}" alt="Avatar" class="rounded-circle"
                                                    width="40px" />
                                            </div>
                                            <div class="col-10">
                                                <strong class="ms-2">{{ $item->bank_name }}</strong><br>
                                                <small class="ms-2">{{ $item->branch_name }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>{{ $item->number }}</td>
                                    ...
                                    <td>{{ $item->amount }}</td>
                                    <td>{{ date_format(date_create($item->maturity_date), 'd M, Y') }}</td>
                                    <td>
                                        @if ($item->status == 1)
