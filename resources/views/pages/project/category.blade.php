...
@section('content')
    <title>KGF | Project Category List</title>
        ...
        <section class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-success alert-dismissible">
                            ...
                            <h5><i class="icon fas fa-check"></i>Project Category</h5>
                            {{ $message }}
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title">Project Category List</h3>
                                ...
                                <tr>
                                    ...
                                    <td class="project-actions text-right text-nowrap">
                                        ...
                                        <a class="btn btn-outline-danger btn-xs"
                                            href="admin-project-category-delete/{{ $item->id }}">
    ...
    <div class="modal fade" id="create_modal">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin-project-category') }}" method="POST">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Create Project Category</h4>
    ...
    <div class="modal fade" id="update_modal">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin-project-category') }}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Update Project Category</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script>
        function edit_func(id) {
            $.ajax({
                url: 'admin-project-category-edit/' + id,
                type: "get",
                dataType: "json",
