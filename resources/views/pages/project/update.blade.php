...
@section('content')
    ...
    <title>KGF | Update Project</title>
                ...
                <div class="col-md-12">
                    @if ($message = Session::get('success'))
                        <div class="alert alert-success alert-dismissible">
                            ...
                            <h5><i class="icon fas fa-check"></i> Update Project</h5>
                            {{ $message }}
                        </div>
                    @endif
                </div>
                                    ...
                                    <div class="bs-stepper-content">
                                        ...
                                        <div id="basic-info" class="content" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                <label>Project Title <span class="badge badge-danger">required</span>
                                                </label>
                                                <textarea class="form-control" name="project_title" placeholder="Project Title">{{ old('project_title', $project_details->project_title) }}</textarea>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="project_code"
                                                        ...
                                                        value="{{ old('project_code', $project_details->project_code) }}">
                                                    ...
                                                    <select class="form-control" name="project_call">
                                                        @foreach ($project_call as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ old('project_call', $project_details->project_call) == $item->id ? 'selected' : '' }}>
                                                                {{ $item->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control" name="project_type">
                                                        @foreach ($project_category as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ old('project_type', $project_details->project_type) == $item->id ? 'selected' : '' }}>
                                                                {{ $item->title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select class="form-control" name="project_category">
                                                        ...
                                                        @forelse ($category_list as $category)
                                                            <option value="{{ $category->id }}"
                                                                {{ old('project_category', $project_details->project_category) == $category->id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="date" class="form-control" name="project_start_date"
                                                        value="{{ old('project_start_date', $project_details->project_start_date) }}">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="date" class="form-control" name="project_end_date"
                                                        value="{{ old('project_end_date', $project_details->project_end_date) }}">
                                                    ...
                                                    <select class="form-control" name="project_research_advisor">
                                                        ...
                                                        @forelse ($employee_list as $employee)
                                                            <option value="{{ $employee->id }}"
                                                                {{ old('project_category', $project_details->project_research_advisor) == $employee->id ? 'selected' : '' }}>
                                                                {{ $employee->emp_name }}
                                                            </option>
                                                        @empty
                                                            <option value="0">Nothing to show</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ old('project_budget', $project_details->project_budget) }}">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <textarea class="form-control" name="project_expected_output" placeholder="Expected Output">{{ old('project_expected_output', $project_details->project_expected_output) }}</textarea>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <textarea class="form-control" name="project_outcomes" placeholder="Outcomes">{{ old('project_outcomes', $project_details->project_outcomes) }}</textarea>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="project_status"
                                                            {{ old('project_status', $project_details->project_status) == 0 ? 'checked' : '' }}>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input id="range_5" type="text" name="project_progress"
                                                        value="{{ old('project_progress', $project_details->project_progress) }}">
                                        ...
                                        <div id="other-info" class="content" role="tabpanel"
                                            ...
                                            <div class="form-group row" id="researcher_div">
                                                @forelse ($project_researcher as $item)
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control select2bs4" name="researcher_id[]"
                                                            ...
                                                            @forelse ($researcher_list as $researcher)
                                                                <option value="{{ $researcher->id }}"
                                                                    {{ old('researcher_id', $item->researcher_id) == $researcher->id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="form-control" name="researcher_role[]">
                                                            <option
                                                                {{ old('researcher_role[]', $item->researcher_role) == 'Coordinator' ? 'selected' : '' }}>
                                                                Coordinator</option>
                                                            <option
                                                                {{ old('researcher_role[]', $item->researcher_role) == 'Principal Investigator' ? 'selected' : '' }}>
                                                                Principal Investigator</option>
                                                            <option
                                                                {{ old('researcher_role[]', $item->researcher_role) == 'Co-Principal Investigator' ? 'selected' : '' }}>
                                                                Co-Principal Investigator</option>
                                                        </select>
                                            ...
                                            @forelse ($project_organization as $item)
                                                <div class="form-group">
                                                    <label>Organization <span
                                                            class="badge badge-danger">required</span></label>
                                                    <select class="form-control select2bs4" name="organization_id[]"
                                                        style="width: 100%;">
                                                        <option selected disabled>Select an Organization</option>
                                                        @forelse ($organization_list as $organization)
                                                            <option value="{{ $organization->id }}"
                                                                {{ old('organization_id', $item->organization_id) == $organization->id ? 'selected' : '' }}>
                                            ...
                                            @forelse ($project_location as $item)
                                                <div class="form-group">
                                                    <label>Location <span
                                                            class="badge badge-danger">required</span></label>
                                        ...
                                        <div id="objective-info" class="content" role="tabpanel"
                                            ...
                                            <div class="form-group" id="objective_div">
                                                @forelse ($project_objective as $item)
                                                    <label>Objective</label>
                                                    <input type="text" class="form-control" name="objective_details[]"
                                                        value="{{ old('objective_details', $item->objective_details) }}">
