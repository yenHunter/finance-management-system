...
@section('content')
    <title>KGF | Technical Bulletin List</title>
        ...
        <section class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-success alert-dismissible">
                            ...
                            <h5><i class="icon fas fa-check"></i>Technical Bulletin</h5>
                            {{ $message }}
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title">Technical Bulletin List</h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-striped projects table-hover" id="list_table">
                        ...
                        <tbody>
                            @forelse ($technical_bulletin as $item)
                                <tr>
                                    <td>
                                        {{ $item->project_code }}
                                    </td>
                                    ...
                                    <td class="project-actions text-right text-nowrap">
                                        ...
                                        <a class="btn btn-outline-danger btn-xs"
                                            href="admin-technical-bulletin-delete/{{ $item->id }}">
    ...
    <div class="modal fade" id="create_modal">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin-technical-bulletin') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Create Technical Bulletin</h4>
    ...
    <div class="modal fade" id="update_modal">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin-technical-bulletin') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Update Technical Bulletin</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script>
        function edit_func(id) {
            $.ajax({
                url: 'admin-technical-bulletin-edit/' + id,
                type: "get",
                dataType: "json",
