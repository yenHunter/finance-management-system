...
@section('content')
    <title>KGF | Annual Report List</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-success alert-dismissible">
                            ...
                            <h5><i class="icon fas fa-check"></i>Annual Report</h5>
                            {{ $message }}
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-striped projects text-nowrap table-hover" id="list_table">
                        ...
                        <tbody>
                            @forelse ($annual_report as $item)
                                <tr>
                                    <td>
                                        {{ $item->title }}
                                        <br />
                                        <small>{{ $item->financial_year }}</small>
                                    </td>
                                    <td>
                                    ...
                                    <td class="project-actions text-right">
                                        ...
                                        <a class="btn btn-outline-danger btn-xs"
                                            href="admin-report-annual-report-delete/{{ $item->id }}">
    ...
    <div class="modal fade" id="create_modal">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin-report-annual-report') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Create Annual Report</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="financial_year"
    ...
    <div class="modal fade" id="update_modal">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin-report-annual-report') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Update Annual Report</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Financial Year</label>
                                    <input class="form-control" type="text" name="financial_year" id="financial_year"
                                        placeholder="Financial Year">
                                </div>
                                <div class="form-group">
                                    <label>File</label>
    ...
    <script>
        function edit_func(id) {
            $.ajax({
                url: 'admin-report-annual-report-edit/' + id,
                type: "get",
                dataType: "json",
                success: function(response) {
                    $('#id').val(response.id);
                    $('#title').val(response.title);
                    $('#financial_year').val(response.financial_year);
