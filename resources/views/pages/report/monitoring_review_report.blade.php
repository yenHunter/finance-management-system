...
@section('content')
    <title>KGF | Monitoring Review Report List</title>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Monitoring Review Report</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin-home') }}">Home</a></li>
                            <li class="breadcrumb-item active">Monitoring Review Report</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-success alert-dismissible">
                            ...
                            <h5><i class="icon fas fa-check"></i>Monitoring Review Report</h5>
                            {{ $message }}
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title">Monitoring Review Report List</h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-striped projects text-nowrap table-hover" id="list_table">
                        ...
                        <tbody>
                            @forelse ($monitoring_review_report as $item)
                                <tr>
                                    <td>
                                        {{ $item->title }}
                                        <br />
                                    ...
                                    <td class="project-actions text-right">
                                        ...
                                        <a class="btn btn-outline-danger btn-xs"
                                            href="admin-report-monitoring-review-report-delete/{{ $item->id }}">
    ...
    <div class="modal fade" id="create_modal">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin-report-monitoring-review-report') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Create Monitoring Review Report</h4>
    ...
    <div class="modal fade" id="update_modal">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin-report-monitoring-review-report') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Update Monitoring Review Report</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script>
        function edit_func(id) {
            $.ajax({
                url: 'admin-report-monitoring-review-report-edit/' + id,
                type: "get",
                dataType: "json",
