...
@section('content')
    <title>KGF | Annual Work Plan List</title>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Annual Work Plan</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title">Annual Work Plan List</h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-striped projects text-nowrap table-hover" id="list_table">
                        ...
                        <tbody>
                            @forelse ($annual_work_plan as $item)
                                <tr>
                                    <td>
                                        {{ $item->title }}
                                        <br />
                                    ...
                                    <td class="project-actions text-right">
                                        ...
                                        <a class="btn btn-outline-danger btn-xs"
                                            href="admin-report-annual-work-plan-delete/{{ $item->id }}">
    ...
    <div class="modal fade" id="create_modal">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin-report-annual-work-plan') }}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    <div class="modal fade" id="update_modal">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('admin-report-annual-work-plan') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Update Annual Work Plan</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
    ...
    <script>
        function edit_func(id) {
            $.ajax({
                url: 'admin-report-annual-work-plan-edit/' + id,
                type: "get",
                dataType: "json",
